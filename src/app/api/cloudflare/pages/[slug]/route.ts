...
export async function GET(
  ...
  try {
    ...
    if (result.result?.[0]?.results?.length) {
      ...
      switch (params.slug) {
        case 'info':
          defaultTitle = 'À propos d\'TECH+';
          defaultContent = 'Bienvenue chez TECH+ - Votre boutique premium de produits d\'exception.';
          break;
        case 'contact':
          defaultTitle = 'Contact TECH+';
          defaultContent = 'Contactez-nous pour toute question concernant nos produits TECH+.';
          break;
        default:
          defaultTitle = 'Page TECH+';
          defaultContent = 'Contenu de la page TECH+.';
      }
